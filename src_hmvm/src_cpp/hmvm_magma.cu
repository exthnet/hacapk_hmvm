...
// ######## ######## ######## ######## ######## ######## ######## ########
template void hmvm_magma<float>(matrix2<float>  *mat2, float *b, int kernel, int dump_result);
template void hmvm_magma<double>(matrix2<double> *mat2, double *b, int kernel, int dump_result);
