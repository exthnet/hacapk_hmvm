...
// ######## ######## ######## ########
template<class T>
void hmvm_omp(const matrix<T> *mat, const matrix2<T> *mat2, const T *b, int dump_result)
{
  int i, nd;
  char fname[0xff];
  FILE *F;
...
// ######## ######## ######## ########
template<class T>
void hmvm_omp_bench(const matrix<T> *mat, const matrix2<T> *mat2, const T *b)
{
  const int L=10;
  int i, l, nd;
...
// ######## ######## ######## ########
template void hmvm_omp<float> (const matrix<float>  *mat, const matrix2<float>  *mat2, const float  *b, int dump_result);
template void hmvm_omp<double>(const matrix<double> *mat, const matrix2<double> *mat2, const double *b, int dump_result);
template void hmvm_omp_bench<float> (const matrix<float>  *mat, const matrix2<float>  *mat2, const float  *b);
template void hmvm_omp_bench<double>(const matrix<double> *mat, const matrix2<double> *mat2, const double *b);
